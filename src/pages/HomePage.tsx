...
export default function HomePage({ params }: { params?: {} }) {
  return (
    <div className="h-dvh bg-white flex justify-center items-center flex-col">
      ...
      <div className="flex gap-15 sm:gap-25">
        <div className="flex flex-col justify-center items-center gap-8 cursor-pointer w-50 h-55 sm:w-65 sm:h-70 text-[1.1rem] hover:text-violet-600 hover:text-[1.25rem] focus:text-[1.2rem] hover:font-bold focus:text-violet-600 focus:font-bold  transition-all">
          <Image
            src={"/cozyProfile.png"}
            width={200}
            height={200}
